        ...
        <div className="flex flex-col gap-3 p-5">
          ...
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              className="corner-md focus:ring-border h-10 w-full bg-gray-800 px-3 text-sm text-gray-100 transition-colors hover:bg-gray-700 focus:ring-1 focus:outline-none"
            />
          </div>
          <div className="flex flex-col gap-2">
            <label
